...
const Categories = () => {
  return (
      ...
      <div className="grid gap-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-5">
        <ProductCard
          bgColor="white"
          image='https://images.pexels.com/photos/906056/pexels-photo-906056.jpeg?auto=compress&cs=tinysrgb&w=400'
          title="Portrait"
        />
        <ProductCard
          bgColor="white"
